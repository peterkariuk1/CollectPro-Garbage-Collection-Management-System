  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        plot: {
          lumpsum: "hsl(var(--plot-lumpsum))",
          "lumpsum-foreground": "hsl(var(--plot-lumpsum-foreground))",
          individual: "hsl(var(--plot-individual))",
          "individual-foreground": "hsl(var(--plot-individual-foreground))",
        },
        sidebar: {
